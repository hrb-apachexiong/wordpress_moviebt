<form method="get" id="searchform" class="search-form" action="<?php echo home_url(); ?>" _lpchecked="1">
	<fieldset>
		<input type="text" name="s" id="s" value="<?php _e('搜索本站','mythemeshop'); ?>" onblur="if (this.value == '') {this.value = '<?php _e('搜索本站','mythemeshop'); ?>';}" onfocus="if (this.value == '<?php _e('搜索本站','mythemeshop'); ?>') {this.value = '';}" >
