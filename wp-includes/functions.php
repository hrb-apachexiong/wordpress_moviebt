...
function wp_guess_url() {
	if ( defined('WP_SITEURL') && '' != WP_SITEURL ) {
		...
		if ( strpos( $_SERVER['REQUEST_URI'], 'wp-admin' ) !== false || strpos( $_SERVER['REQUEST_URI'], 'wp-login-xionghe.php' ) !== false ) {
			$path = preg_replace( '#/(wp-admin/.*|wp-login-xionghe.php)#i', '', $_SERVER['REQUEST_URI'] );
